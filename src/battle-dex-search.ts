...
class BattleTypeSearch extends BattleTypedSearch<'type'> {
	...
	getTable() {
		...
		// 		},
		// 	}
		// 	const buf = JSON.stringify(DigimonTypeChart);
	...
	getDefaultResults(): SearchRow[] {
		...
		if (this.formatType === 'digimon') {
			...
			for (let id in DigimonTypeChart) {
