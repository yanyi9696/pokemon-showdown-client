...
(function ($) {
	...
	var ReplayUploadedPopup = this.ReplayUploadedPopup = Popup.extend({
		...
		initialize: function (data) {
			...
			buf += '<p> <a class="replay-link" href="https://' + Config.routes.replays + '/files/' + data.uri + '" target="_blank" class="no-panel-intercept">http://' + Config.routes.replays + '/files/' + data.uri + '</a> <button name="copyReplayLink">Copy</button></p>';
