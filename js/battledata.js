...
if((_id9.startsWith('orichalcumpulse')||_id9.startsWith('hadronengine'))&&!['orichalcumpulse','hadronengine'].includes(_id9)){
var _stat2=_id9.slice(-3);
var _template15=this.template('start',_id9.slice(0,_id9.length-3));
return _line4+_template15.replace('[POKEMON]',this.pokemon(_pokemon10)).replace('[STAT]',BattleTextParser.stat(_stat2));
}
...
return _line4+_template16.replace('[POKEMON]',this.pokemon(_pokemon10)).replace('[EFFECT]',this.effect(_effect3)).replace('[MOVE]',_arg).replace('[SOURCE]',this.pokemon(kwArgs.of)).replace('[ITEM]',this.effect(kwArgs.from));
}
...
return _line5+_template18.replace('[POKEMON]',this.pokemon(_pokemon11)).replace('[EFFECT]',this.effect(_effect4)).replace('[SOURCE]',this.pokemon(kwArgs.of)).replace('[ITEM]',this.effect(kwArgs.from));
}
...
return _line6+_template20.replace('[POKEMON]',this.pokemon(_pokemon12)).replace('[ABILITY]',this.effect(ability)).replace('[SOURCE]',this.pokemon(kwArgs.of));
}
...
return _line8+_template24.replace('[POKEMON]',this.pokemon(_pokemon14)).replace('[ITEM]',this.effect(item)).replace('[SOURCE]',this.pokemon(_target||kwArgs.of));
}
if(_id12==='frisk'){
...
return _line8+_template25.replace('[POKEMON]',this.pokemon(kwArgs.of)).replace('[ITEM]',this.effect(item)).replace('[TARGET]',this.pokemon(_pokemon14));
}
if(kwArgs.from){
...
return _line9+_template29.replace('[POKEMON]',this.pokemon(_pokemon15)).replace('[ITEM]',this.effect(_item)).replace('[MOVE]',kwArgs.move);
}
if(_id13==='stealeat'){
...
return _line9+_template31.replace('[POKEMON]',this.pokemon(_pokemon15)).replace('[ITEM]',this.effect(_item)).replace('[SOURCE]',this.pokemon(kwArgs.of));
}
if(kwArgs.weaken){
...
var _template35=this.template('start',status);
...
return _template36.replace('[POKEMON]',this.pokemon(_pokemon17));
}
...
return _line11+_template37.replace('[POKEMON]',this.pokemon(_pokemon17)).replace('[ITEM]',this.effect(kwArgs.from));
}
if(kwArgs.thaw){
var _template38=this.template('endFromMove',_status);
return _line11+_template38.replace('[POKEMON]',this.pokemon(_pokemon17)).replace('[MOVE]',this.effect(kwArgs.from));
}
var _template39=this.template('end',_status,'NODEFAULT');
if(!_template39)_template39=this.template('end').replace('[EFFECT]',_status);
return _line11+_template39.replace('[POKEMON]',this.pokemon(_pokemon17));
}
...
return _line12+_template40.replace('[POKEMON]',this.pokemon(kwArgs.of)).replace('[TARGET]',this.pokemon(_pokemon18));
}
var _template41=this.template('start',_effect5,'NODEFAULT');
if(!_template41)_template41=this.template('start').replace('[EFFECT]',this.effect(_effect5));
return _line12+_template41.replace('[POKEMON]',this.pokemon(_pokemon18)).replace('[SOURCE]',this.pokemon(kwArgs.of)).replace('[TEAM]',this.team(_pokemon18.slice(0,2)));
}

case'-sidestart':{
var _side5=args[1],_effect6=args[2];
var _template42=this.template('start',_effect6,'NODEFAULT');
if(!_template42)_template42=this.template('startTeamEffect').replace('[EFFECT]',this.effect(_effect6));
return _template42.replace('[TEAM]',this.team(_side5)).replace('[PARTY]',this.party(_side5));
}

case'-sideend':{
var _side6=args[1],_effect7=args[2];
var _template43=this.template('end',_effect7,'NODEFAULT');
if(!_template43)_template43=this.template('endTeamEffect').replace('[EFFECT]',this.effect(_effect7));
return _template43.replace('[TEAM]',this.team(_side6)).replace('[PARTY]',this.party(_side6));
}

case'-weather':{
var weather=args[1];
if(!weather||weather==='none'){
var _template44=this.template('end',kwArgs.from,'NODEFAULT');
if(!_template44)return this.template('endFieldEffect').replace('[EFFECT]',this.effect(weather));
return _template44;
}
if(kwArgs.upkeep){
...
var _template45=this.template('start',weather,'NODEFAULT');
if(!_template45)_template45=this.template('startFieldEffect').replace('[EFFECT]',this.effect(weather));
return _line13+_template45;
}
...
var _template46=this.template(_templateId3,_effect8,'NODEFAULT');
if(!_template46)_template46=this.template('startFieldEffect').replace('[EFFECT]',this.effect(_effect8));
return _line14+_template46.replace('[POKEMON]',this.pokemon(kwArgs.of));
}

case'-fieldend':{
var _effect9=args[1];
var _template47=this.template('end',_effect9,'NODEFAULT');
if(!_template47)_template47=this.template('endFieldEffect').replace('[EFFECT]',this.effect(_effect9));
return _template47;
}
...
var _template49=this.template('changeAbility',_id15);
...
var _template50=this.template('activate',_id15);
return _line15+_template50.replace('[POKEMON]',this.pokemon(_pokemon19)).replace(/\[TARGET\]/g,this.pokemon(_target2));
}
...
var _template51=this.template(_templateId4,_effect11,'NODEFAULT');
if(!_template51){
if(_line15)return _line15;
_template51=this.template('activate');
return _line15+_template51.replace('[EFFECT]',this.effect(_effect11));
}

if(_id15==='brickbreak'){
_template51=_template51.replace('[TEAM]',this.team(_target2.slice(0,2)));
}
if(kwArgs.ability){
...
_template51=_template51.replace('[MOVE]',kwArgs.move).replace('[NUMBER]',kwArgs.number).replace('[ITEM]',kwArgs.item).replace('[NAME]',kwArgs.name);
}
return _line15+_template51.replace('[POKEMON]',this.pokemon(_pokemon19)).replace('[TARGET]',this.pokemon(_target2)).replace('[SOURCE]',this.pokemon(kwArgs.of));
}

case'-prepare':{
var _pokemon20=args[1],_effect12=args[2],_target3=args[3];
var _template52=this.template('prepare',_effect12);
return _template52.replace('[POKEMON]',this.pokemon(_pokemon20)).replace('[TARGET]',this.pokemon(_target3));
}

case'-damage':{
var _pokemon21=args[1],percentage=args[3];
var _template53=this.template('damage',kwArgs.from,'NODEFAULT');
var _line16=this.maybeAbility(kwArgs.from,kwArgs.of||_pokemon21);
var _id16=BattleTextParser.effectId(kwArgs.from);
if(_template53){
return _line16+_template53.replace('[POKEMON]',this.pokemon(_pokemon21));
}

if(!kwArgs.from){
_template53=this.template(percentage?'damagePercentage':'damage');
return _line16+_template53.replace('[POKEMON]',this.pokemon(_pokemon21)).replace('[PERCENTAGE]',percentage);
}
if(kwArgs.from.startsWith('item:')){
_template53=this.template(kwArgs.of?'damageFromPokemon':'damageFromItem');
return _line16+_template53.replace('[POKEMON]',this.pokemon(_pokemon21)).replace('[ITEM]',this.effect(kwArgs.from)).replace('[SOURCE]',this.pokemon(kwArgs.of));
}
if(kwArgs.partiallytrapped||_id16==='bind'||_id16==='wrap'){
_template53=this.template('damageFromPartialTrapping');
return _line16+_template53.replace('[POKEMON]',this.pokemon(_pokemon21)).replace('[MOVE]',this.effect(kwArgs.from));
}

_template53=this.template('damage');
return _line16+_template53.replace('[POKEMON]',this.pokemon(_pokemon21));
}

case'-heal':{
var _pokemon22=args[1];
var _template54=this.template('heal',kwArgs.from,'NODEFAULT');
var _line17=this.maybeAbility(kwArgs.from,kwArgs.of||_pokemon22);
if(_template54){
return _line17+_template54.replace('[POKEMON]',this.pokemon(_pokemon22)).replace('[SOURCE]',this.pokemon(kwArgs.of)).replace('[NICKNAME]',kwArgs.wisher);
}

if(kwArgs.from&&!kwArgs.from.startsWith('ability:')){
_template54=this.template('healFromEffect');
return _line17+_template54.replace('[POKEMON]',this.pokemon(_pokemon22)).replace('[EFFECT]',this.effect(kwArgs.from));
}

_template54=this.template('heal');
return _line17+_template54.replace('[POKEMON]',this.pokemon(_pokemon22));
}

case'-boost':case'-unboost':{var _kwArgs$from4;
var _pokemon23=args[1],_stat3=args[2],_num4=args[3];
if(_stat3==='spa'&&this.gen===1)_stat3='spc';
...
var _template55=this.template(_templateId5+'FromItem',kwArgs.from);
return _line18+_template55.replace('[POKEMON]',this.pokemon(_pokemon23)).replace('[STAT]',BattleTextParser.stat(_stat3)).replace('[ITEM]',this.effect(kwArgs.from));
}
var _template56=this.template(_templateId5,kwArgs.from);
return _line18+_template56.replace(/\[POKEMON\]/g,this.pokemon(_pokemon23)).replace('[STAT]',BattleTextParser.stat(_stat3));
}
...
var _template57=this.template('boost',_effect13);
return _line19+_template57.replace('[POKEMON]',this.pokemon(_pokemon24));
}
...
var _template58=this.template(_templateId6,kwArgs.from);
return _line20+_template58.replace('[POKEMON]',this.pokemon(_pokemon25)).replace('[TARGET]',this.pokemon(_target4));
}

case'-copyboost':{
var _pokemon26=args[1],_target5=args[2];
var _line21=this.maybeAbility(kwArgs.from,kwArgs.of||_pokemon26);
var _template59=this.template('copyBoost',kwArgs.from);
return _line21+_template59.replace('[POKEMON]',this.pokemon(_pokemon26)).replace('[TARGET]',this.pokemon(_target5));
}
...
var _template60=this.template(_templateId7,kwArgs.from);
return _line22+_template60.replace('[POKEMON]',this.pokemon(_pokemon27)).replace('[SOURCE]',this.pokemon(source));
}

case'-invertboost':{
var _pokemon28=args[1];
var _line23=this.maybeAbility(kwArgs.from,kwArgs.of||_pokemon28);
var _template61=this.template('invertBoost',kwArgs.from);
return _line23+_template61.replace('[POKEMON]',this.pokemon(_pokemon28));
}
...
var _template63=this.template(_templateId9,_effect14);
return _line24+_template63.replace('[POKEMON]',this.pokemon(_pokemon30)).replace('[SOURCE]',this.pokemon(attacker||kwArgs.of)).replace('[MOVE]',_move2);
}

case'-fail':{
var _pokemon31=args[1],_effect15=args[2],_stat4=args[3];
...
var _template64=this.template(_templateId10,kwArgs.from);
if(_template64){
return _line25+_template64.replace('[POKEMON]',this.pokemon(_pokemon31));
}

if(_id19==='unboost'){
_template64=this.template(_stat4?'failSingular':'fail','unboost');
return _line25+_template64.replace('[POKEMON]',this.pokemon(_pokemon31)).replace('[STAT]',_stat4);
}
...
_template64=this.template(_templateId10,_id19);
return _line25+_template64.replace('[POKEMON]',this.pokemon(_pokemon31));
}
...
var _template65=this.template('block',kwArgs.from);
if(!_template65){
var _templateId11=kwArgs.ohko?'immuneOHKO':'immune';
_template65=this.template(_pokemon32?_templateId11:'immuneNoPokemon',kwArgs.from);
}
return _line26+_template65.replace('[POKEMON]',this.pokemon(_pokemon32));
}
...
if(!_pokemon33){
var _template66=this.template('missNoPokemon');
return _line27+_template66.replace('[SOURCE]',this.pokemon(_source));
}
var _template67=this.template('miss');
return _line27+_template67.replace('[POKEMON]',this.pokemon(_pokemon33));
}
...
var _template68=this.template(_templateId12,_id20);
var _side7=_pokemon34.slice(0,2);
var pokemonName=this.pokemon(_pokemon34);
if(cmd==='-mega'){
var template2=this.template('transformMega');
_template68+=template2.replace('[POKEMON]',pokemonName).replace('[SPECIES]',species);
}
return _template68.replace('[POKEMON]',pokemonName).replace('[ITEM]',_item2).replace('[TRAINER]',this.trainer(_side7));
}
...
var _template69=this.template(_templateId13,_id21);
var _pokemonName=this.pokemon(_pokemon35);
return _template69.replace('[POKEMON]',_pokemonName).replace('[TYPE]',type);
}

case'-zpower':{
var _pokemon36=args[1];
var _template70=this.template('zPower');
return _template70.replace('[POKEMON]',this.pokemon(_pokemon36));
}

case'-burst':{
var _pokemon37=args[1];
var _template71=this.template('activate',"Ultranecrozium Z");
return _template71.replace('[POKEMON]',this.pokemon(_pokemon37));
}

case'-zbroken':{
var _pokemon38=args[1];
var _template72=this.template('zBroken');
return _template72.replace('[POKEMON]',this.pokemon(_pokemon38));
}
...
var _template73=this.template('activate',"Water Pledge");
return _template73.replace('[POKEMON]',this.pokemon(_pokemon39)).replace('[TARGET]',this.pokemon(_target6));
}
