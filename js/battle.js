...
'airballoon','attract','autotomize','disable','encore','foresight','gmaxchistrike','imprison','laserfocus','mimic','miracleeye','nightmare','saltcure','smackdown','stockpile1','stockpile2','stockpile3','syrupbomb','torment','typeadd','typechange','yawn','utilityumbrella'];for(var _i4=0,_Dex$statNamesExceptH2=
...
}for(var _i6=0,_Dex$statNamesExceptH4=

Dex.statNamesExceptHP;_i6<_Dex$statNamesExceptH4.length;_i6++){var _statName=_Dex$statNamesExceptH4[_i6];
volatilesToRemove.push('orichalcumpulse'+_statName);
volatilesToRemove.push('hadronengine'+_statName);
}for(var _i8=0;_i8<
volatilesToRemove.length;_i8++){var volatile=volatilesToRemove[_i8];
delete this.volatiles[volatile];
}
}
...
return this.side.battle.dex.species.getFromPokemon(Object.assign({},this,{speciesForme:this.getSpeciesForme(serverPokemon)}));
};_proto.
...
clearPokemon=function clearPokemon(){for(var _i10=0,_this$pokemon2=
this.pokemon;_i10<_this$pokemon2.length;_i10++){var _pokemon=_this$pokemon2[_i10];_pokemon.destroy();}
this.pokemon=[];
...
var illusionFound=null;for(var _i12=0,_this$pokemon4=
this.pokemon;_i12<_this$pokemon4.length;_i12++){var curPoke=_this$pokemon4[_i12];
...
if(!illusionFound){for(var _i14=0,_this$pokemon6=




this.pokemon;_i14<_this$pokemon6.length;_i14++){var _curPoke=_this$pokemon6[_i14];
...
hasPseudoWeather=function hasPseudoWeather(weather){for(var _i16=0,_this$pseudoWeather2=
this.pseudoWeather;_i16<_this$pseudoWeather2.length;_i16++){var _ref=_this$pseudoWeather2[_i16];var pseudoWeatherName=_ref[0];
...
for(var i=0;i<2;i++){
var side=this.sides[i];for(var _i18=0,_side$active2=
...
ngasActive=function ngasActive(){for(var _i20=0,_this$getAllActive2=
this.getAllActive();_i20<_this$getAllActive2.length;_i20++){var active=_this$getAllActive2[_i20];
...
}for(var _i22=0,_this$getAllActive4=
this.getAllActive();_i22<_this$getAllActive4.length;_i22++){var active=_this$getAllActive4[_i22];
...
this.pseudoWeather=[];
this.lastMove='';for(var _i24=0,_this$sides2=

this.sides;_i24<_this$sides2.length;_i24++){var side=_this$sides2[_i24];
if(side)side.reset();
}
this.myPokemon=null;
...
sideConditions.length;_i26++){var _id3=sideConditions[_i26];
...
pokemon.removeTurnstatus('breathofwyvern');
}
...
stats.length;_i42++){var _stat4=stats[_i42];
...
_stats.length;_i44++){var _stat7=_stats[_i44];
...
this.scene.resultAnim(_poke23,'Umbrella','good');
this.scene.updateWeather();
}
break;
}
...
_poke24.removeVolatile('utilityumbrella');
...
_poke33.removeVolatile('orichalcumpulseatk');
_poke33.removeVolatile('orichalcumpulsedef');
_poke33.removeVolatile('orichalcumpulsespa');
_poke33.removeVolatile('orichalcumpulsespd');
_poke33.removeVolatile('orichalcumpulsespe');
break;
case'hadronengine':
if(!this.tier.includes('More Balanced Hackmons'))break;
_poke33.removeVolatile('hadronengineatk');
_poke33.removeVolatile('hadronenginedef');
_poke33.removeVolatile('hadronenginespa');
_poke33.removeVolatile('hadronenginespd');
_poke33.removeVolatile('hadronenginespe');
break;
default:
...
if(this.tier.includes('More Balanced Hackmons')&&_effect23.id.endsWith('room')){
maxTimeLeft=8;
}
...
this.sides[siden].pokemon;_i60<_this$sides$siden$pok2.length;_i60++){var _pokemon4=_this$sides$siden$pok2[_i60];
...
side.pokemon;_i62<_side$pokemon2.length;_i62++){var _pokemon5=_side$pokemon2[_i62];
...
break;
default:for(var _i64=0,_this$sides6=
this.sides;_i64<_this$sides6.length;_i64++){var side=_this$sides6[_i64];side.active=[null];}
break;
}
...
stack.length;_i66++){var line=stack[_i66];
if(/\brun\b/.test(line)){
break;
}
this.log(['error',line]);
