...
if(this.battle.dex.modid.includes('gen9morebalancedhackmons')&&
...
if(this.battle.dex.modid.includes('infinitefusion')){
...
var supportsAbilities=this.battle.gen>2&&!this.battle.dex.modid.includes("gen7letsgo");
var abilityPossibility=this.battle.dex.modid.includes("hackmons")||this.battle.dex.modid.includes('createmons');
...
serverPokemon.moves;_i10<_serverPokemon$moves2.length;_i10++){var _moveid=_serverPokemon$moves2[_i10];
var move=this.battle.dex.moves.get(_moveid);
...
text+="<p class=\"section\">";for(var _i14=0,_clientPokemon$moveTr2=
...
if(this.battle.dex.modid.includes('gen9morebalancedhackmons')){for(var _i24=0,_this$battle$getAllAc2=
this.battle.getAllActive();_i24<_this$battle$getAllAc2.length;_i24++){var activePokemon=_this$battle$getAllAc2[_i24];
...
if(ability==='purepower'&&!this.battle.dex.modid.includes('gen9morebalancedhackmons')||
ability==='hugepower'){
stats.atk*=2;
}
...
if(ability==='orichalcumpulse'&&!this.battle.dex.modid.includes('gen9morebalancedhackmons')){
stats.atk=Math.floor(stats.atk*1.3);
}
var allyActive=clientPokemon==null?void 0:clientPokemon.side.active;
if(allyActive){for(var _i26=0;_i26<
allyActive.length;_i26++){var ally=allyActive[_i26];
...
speedModifiers.push(2);
}for(var _i28=0,_Dex$statNamesExceptH6=
Dex.statNamesExceptHP;_i28<_Dex$statNamesExceptH6.length;_i28++){var _statName2=_Dex$statNamesExceptH6[_i28];
if(clientPokemon.volatiles['protosynthesis'+_statName2]||clientPokemon.volatiles['quarkdrive'+_statName2]){
if(_statName2==='spe'||this.battle.dex.modid.includes('gen9morebalancedhackmons')){
...
if(clientPokemon.volatiles['orichalcumpulse'+_statName2]||clientPokemon.volatiles['hadronengine'+_statName2]){
if(_statName2==='spe'){
speedModifiers.push(1.5);
}else{
stats[_statName2]=Math.floor(stats[_statName2]*1.3);
...
if(ability==='hadronengine'&&!this.battle.dex.modid.includes('gen9morebalancedhackmons')){
...
if(item==='souldew'&&(this.battle.gen<=6||this.battle.dex.modid.includes('gen9morebalancedhackmons'))&&(
...
var abilityName=ability==='plus'?'Plus':'Minus';for(var _i30=0;_i30<
_allyActive.length;_i30++){var _ally=_allyActive[_i30];
...
if(!short){
var hasModifiedStat=false;for(var _i34=0,_Dex$statNamesExceptH8=
...
buf+='<p>';
}for(var _i36=0,_Dex$statNamesExceptH10=

Dex.statNamesExceptHP;_i36<_Dex$statNamesExceptH10.length;_i36++){var _statName3=_Dex$statNamesExceptH10[_i36];
...
pokemon.moveTrack;_i38<_pokemon$moveTrack2.length;_i38++){var _ref2=_pokemon$moveTrack2[_i38];var moveName=_ref2[0];var ppUsed=_ref2[1];
...
if(item.name==='Soul Dew'&&(this.battle.gen<7||this.battle.dex.modid.includes('gen9morebalancedhackmons'))){
return value;
}
...
if(!types)types=this.getPokemonTypes(pokemon);for(var _i52=0,_types2=
types;_i52<_types2.length;_i52++){var curType=_types2[_i52];
...
var allyAbility=this.battle.dex.abilities.get(ally.ability).name;
...
var species=clientPokemon.getSpecies(serverPokemon||undefined);
