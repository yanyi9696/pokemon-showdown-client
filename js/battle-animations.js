...
this.battle.sides;_i16<_this$battle$sides6.length;_i16++){var _side$missedPokemon,_side$missedPokemon$s;var side=_this$battle$sides6[_i16];
...
if(this.battle.tier.includes('More Balanced Hackmons')){for(var _i18=0,_this$battle$getAllAc2=
this.battle.getAllActive();_i18<_this$battle$getAllAc2.length;_i18++){var pokemon=_this$battle$getAllAc2[_i18];
if(toID(pokemon.item)==='utilityumbrella'){
nullifyWeather=true;
break;
}
}
...
if(this.battle.tier.includes('More Balanced Hackmons')){for(var _i22=0,_this$battle$getAllAc4=
this.battle.getAllActive();_i22<_this$battle$getAllAc4.length;_i22++){var pokemon=_this$battle$getAllAc4[_i22];
if(toID(pokemon.item)==='utilityumbrella'){
weather='';
break;
}
...
var terrain='';for(var _i24=0,_this$battle$pseudoWe4=
this.battle.pseudoWeather;_i24<_this$battle$pseudoWe4.length;_i24++){var pseudoWeatherData=_this$battle$pseudoWe4[_i24];
...
this.battle.sides;_i26<_this$battle$sides8.length;_i26++){var side=_this$battle$sides8[_i26];
...
z:this.z,
opacity:0.5
},this.subsp),300);for(var _i30=0,_this$scene$battle$si2=
this.scene.battle.sides;_i30<_this$scene$battle$si2.length;_i30++){var side=_this$scene$battle$si2[_i30];for(var _i32=0,_side$active4=
side.active;_i32<_side$active4.length;_i32++){var active=_side$active4[_i32];
...
types.length;_i36++){var type=types[_i36];
...
for(var _i38 in pokemon.movestatuses){
status+=PokemonSprite.getEffectTag(_i38);
}
