(function (exports, $) {
	...
	exports.TeambuilderRoom = exports.Room.extend({
		...
		getSetPoint: function (dex, set) {
			...
			details.push(this.typeToPoint[types[0]]);
			details.push(this.typeToPoint[types[0]]);
			...
			if (types.length < 2 || types[1] === types[0]) {
				...
				details[1] += this.typeToPoint[types[1]];
				details.push(this.typeToPoint[types[1]]);
			}
		
			// ability points
			const abilityPoint = this.abilityToPoint[dex.abilities.get(set.ability).id] || 1;
			...
			for (const move of set.moves) {
				const point = this.moveToPoint[dex.moves.get(move).id] || 0.5
				details.push(point);
				details[5] += point;
			}
