...
requireScript('../config/config.js?a7'); // Config file not found locally
...
requireScript('../data/pokedex-mini.js?a7'); // File not found locally
requireScript('../data/pokedex-mini-bw.js?a7'); // File not found locally
