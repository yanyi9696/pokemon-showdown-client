(function (exports, $) {
	...
	exports.TeambuilderRoom = exports.Room.extend({
		...
		renderSet: function (set, i) {
			...
			var renderHiddenPower = this.curTeam.gen < 8 && !isLetsGo || isNatDex || isBDSP && species.baseSpecies === "Unown";
		...
		checkPoint: function (i, button) {
			...
			app.addPopupMessage(
				'S: ' + pointDetails[0] + ' = ' + pointDetails[1].toFixed(2) + ' * ' + pointDetails[2].toFixed(2) + ' * ' + pointDetails[3].toFixed(2) + ' * 10' + '\n' +
		...
		unChooseMove: function (moveName) {
			var set = this.curSet;
			if (!moveName || !set || this.curTeam.dex.modid.includes('hiddentype')) return;
		...
		canHyperTrain: function (set) {
			if (this.curTeam.gen < 7 || this.curTeam.dex.modid.includes('hiddentype')) return false;
			var format = this.curTeam.format;
		...
		setPokemon: function (val, selectNext) {
			...
			var customMegaStones = {
				...
				'Excadrill-Mega': 'Excadrite', 'Excadrill-Mega-Fantasy': 'Excadrite',
				'Meganium-Mega': 'Meganiumite', 'Meganium-Mega-Fantasy': 'Meganiumite',
				'Greninja-Mega': 'Greninjite', 'Greninja-Mega-Fantasy': 'Greninjite',
				...
				'Floette-Mega': 'Floettite', 'Floette-Mega-Fantasy': 'Floettite',
				'Skarmory-Mega': 'Skarmorite', 'Skarmory-Mega-Fantasy': 'Skarmorite',
				...
				'Garchomp-Mega-Z': 'Garchompite Z', 'Garchomp-Mega-Z-Fantasy': 'Garchompite Z',
				'Glimmora-Mega': 'Glimmoranite',
				'Golisopod-Mega': 'Golisopite', 'Golisopod-Mega-Fantasy': 'Golisopite',
				'Golurk-Mega': 'Golurkite', 'Golurk-Mega-Fantasy': 'Golurkite',
