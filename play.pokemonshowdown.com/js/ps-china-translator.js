...
var translations = {
    ...
    "Resist": "抵抗",
    "Weak": "弱点",
    "Resist includes immunities. Based on current formes and persistent type-related abilities; items, Terastallization, and other battle effects are not included.": "抵抗包含免疫。按当前形态与常驻的属性相关特性估算，不计道具、太晶化及其他对战效果。",
    "Add Pokemon": "添加宝可梦",
    "This format supports a maximum of 9 Pokémon per team.": "这个分级每支队伍最多可携带 9 只宝可梦。",
    "Male": "雄性",
    "Female": "雌性",
    "Genderless": "无性别",
    "Format List": "分级列表",
...
var regex_tolinghunshayuan = new RegExp(/^The opposing (.+?) became trapped by Ling Hun Sha Yuan!$/);
var regex_linghunshayuan = new RegExp(/^(.+?) became trapped by Ling Hun Sha Yuan!$/);
