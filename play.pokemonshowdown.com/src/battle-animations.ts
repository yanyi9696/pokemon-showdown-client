...
export class PokemonSprite extends Sprite {
	...
	protected static statusTable: { [id: string]: [string, 'good' | 'bad' | 'neutral'] | null | string } = {
		...
		gemboostbug: ['虫之宝石: 1.1', 'good'],
		gemboostdark: ['恶之宝石: 1.1', 'good'],
		gemboostdragon: ['龙之宝石: 1.1', 'good'],
		gemboostelectric: ['电之宝石: 1.1', 'good'],
		gemboostfairy: ['妖精宝石: 1.1', 'good'],
		gemboostfighting: ['格斗宝石: 1.1', 'good'],
		gemboostfire: ['火之宝石: 1.1', 'good'],
		gemboostflying: ['飞行宝石: 1.1', 'good'],
		gemboostghost: ['幽灵宝石: 1.1', 'good'],
		gemboostgrass: ['草之宝石: 1.1', 'good'],
		gemboostground: ['地面宝石: 1.1', 'good'],
		gemboostice: ['冰之宝石: 1.1', 'good'],
		gemboostnormal: ['一般宝石: 1.1', 'good'],
		gemboostpoison: ['毒之宝石: 1.1', 'good'],
		gemboostpsychic: ['超能宝石: 1.1', 'good'],
	...
	updateStatbar(pokemon: Pokemon, updatePrevhp?: boolean, updateHp?: boolean) {
		...
		if (pokemon.status === 'brn') {
			...
			status += '<span class="frz">FST</span> '; 
		}
		if (pokemon.terastallized) {
...
BattleStatusAnims['fst'] = BattleStatusAnims['frz'];
