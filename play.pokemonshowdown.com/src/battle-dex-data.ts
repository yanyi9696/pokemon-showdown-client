...
export const BattlePokemonIconIndexes: { [id: string]: number } = {
	...
	zoruahisui: 1032 + 215, zoruahisuifantasy: 1032 + 215, // Added fantasy mapping
	zoroarkhisui: 1032 + 216, zoroarkhisuifantasy: 1032 + 216, // Added fantasy mapping
	...
	gengarmega: 1320 + 8, gengarmegafantasy: 1320 + 8,// Added fantasy mapping
	...
	tyranitarmega: 1320 + 20, tyranitarmegafantasy: 1320 + 20,// Added fantasy mapping
	sceptilemega: 1320 + 21, sceptilemegafantasy: 1320 + 21,// Added fantasy mapping
	...
	sharpedomega: 1320 + 30, sharpedomegafantasy: 1320 + 30,// Added fantasy mapping
	cameruptmega: 1320 + 31,
	altariamega: 1320 + 32, altariamegafantasy: 1320 + 32,// Added fantasy mapping
	banettemega: 1320 + 33,
	...
	salamencemega: 1320 + 36, salamencemegafantasy: 1320 + 36, // Added fantasy mapping
	metagrossmega: 1320 + 37, metagrossmegafantasy: 1320 + 37, // Added fantasy mapping
	latiasmega: 1320 + 38,
	latiosmega: 1320 + 39,
	...
	gallademega: 1320 + 47,
	audinomega: 1320 + 48, audinomegafantasy: 1320 + 48, // Added fantasy mapping
	dianciemega: 1320 + 49,
	...
	pyroarmega: 1320 + 101,
	floettemega: 1320 + 102, floettemegafantasy: 1320 + 102, // Added fantasy mapping
	malamarmega: 1320 + 103, malamarmegafantasy: 1320 + 103, // Added fantasy mapping
	...
	darkraimega: 1320 + 118, darkraimegafantasy: 1320 + 118, // Added fantasy mapping
	...
	steelixmegazfantasy: 1657, // Added fantasy mapping
	lurantistotemfantasy: 1658, // Added fantasy mapping
...
export type StatusName = 'par' | 'psn' | 'frz' | 'fst' | 'slp' | 'brn';
